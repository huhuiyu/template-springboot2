...
public class SwaggerConfig {
  ...
  private ApiInfo apiInfo() {
    // api描述信息
    return new ApiInfoBuilder().contact(new Contact("胡辉煜", "https://huhuiyu.top", "1069306849@qq.com")).title("胡辉煜的springsecurity演示项目").description("胡辉煜的教学后端接口项目").version("1.0.0").build();
  }

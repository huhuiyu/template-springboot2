...
insert into tb_security_role(role_name,role_info) values('admin','管理员');
insert into tb_security_role(role_name,role_info) values('user','用户');
...
insert into tb_security_user(username,password,nickname,rid) values('admin','admin','内置管理员',1);
insert into tb_security_user(username,password,nickname,rid) values('user','user','内置用户',2);
insert into tb_security_user(username,password,nickname,rid,enable) values('test','test','测试用户',2,'n');
